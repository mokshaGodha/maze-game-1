...
function setup() {
  ...
  wall2 = new BrickWall(width-width + 40, height-200, 10, 100, 20, 15, 4, "horizontal");
  wall3 = createSprite(70, height-300, 20,200, 10, 100, 20, 15,40 )
  ...
  wall18= createSprite(230, height - 300, 90, 20)
  wall19= createSprite(700, height - 750, 20, 90)
  wall20= createSprite(500, height - 1550, 20, 90)
  wall21= createSprite(1000, height - 2250, 90, 20)
  wall22= createSprite(100, height - 580, 20, 40)
  wall23= createSprite(100, height - 1000, 20, 70)
  wall24= createSprite(100, height - 1740, 130, 20)
  wall25= createSprite(100, height - 2840, 20, 90)
  wall26= createSprite(100, height - 3720, 20, 20)
  wall27= createSprite(100, height - 380, 20, 180)
  wall28 = createSprite(100, height - 1780, 30, 20)
  wall29= createSprite(100, height - 1000, 20, 90)
  wall30= createSprite(100, height - 5000, 20, 90)
